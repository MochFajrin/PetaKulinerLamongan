<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="https://unisla.ac.id">5B Teknik Informatika Unisla</a>.</strong> All rights reserved.
</footer>
...
<script src="<?= base_url('assets/js/crud_laporan.js') ?>"></script>
<!-- Bootstrap 4 -->
