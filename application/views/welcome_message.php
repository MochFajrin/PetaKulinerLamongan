		...
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="<?= base_url('assets/templates/adminLte/'); ?>index3.html" class="nav-link">Home</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="<?= base_url('assets/templates/adminLte/'); ?>index.html" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Dashboard v1</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?= base_url('assets/templates/adminLte/'); ?>index2.html" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Dashboard v2</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?= base_url('assets/templates/adminLte/'); ?>index3.html" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Dashboard v3</p>
									</a>
								</li>
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="<?= base_url('assets/templates/adminLte/'); ?>starter.html" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Starter Page</p>
									</a>
								</li>
						...
						<li class="nav-item">
							<a href="<?= base_url('assets/templates/adminLte/'); ?>iframe.html" class="nav-link">
